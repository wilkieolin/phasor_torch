...
STUDIES = [
    ("lca_plain_tier1",          "d1 PLAIN LCA, Tier-1 readout (softmax-CE + logsumexp)"),
    ("lca_attn_d1_tier1",        "d1 attn-only (NO FFN), Tier-1 readout"),
    ("lca_d1_rezero_tier1",      "d1 rezero+FFN, Tier-1 readout (hippo_tau_max searched)"),
    ("lca_d2_rezero_tier1",      "d2 rezero+FFN, Tier-1 readout (hippo_tau_max searched)"),
